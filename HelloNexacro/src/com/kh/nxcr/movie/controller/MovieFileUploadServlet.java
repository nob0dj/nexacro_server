...
import com.kh.nxcr.movie.model.exception.MovieFileUploadException;
...
public class MovieFileUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!ServletFileUpload.isMultipartContent(request)) {
			throw new MovieFileUploadException("enctype=\"multipart/form-data\"를 확인하세요!!");
		}
		...
		String saveDirectory = getServletContext().getRealPath("/_resource_/_images_/movies");
