...
public class EmplSaveServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//a. 하나의 데이터인 경우
//		Variable varA = reqPlatformData.getVariable("a");
//		String a = varA.getString();
//		System.out.println("a = " + a);
		
		//b. 복수개인 경우 : 체크박스 같은 처리 불가.
		VariableList reqVarList = reqPlatformData.getVariableList();
		String a = reqVarList.getString("a");
		String b = reqVarList.getString("b");
...
//		DataSet dataSet = dataSetList.get("in_ds");
		...
		try {
			...
			employeeService.saveEmployee(inDataSet);
		} catch (Throwable th) {
			th.printStackTrace();
			errorCode = -1;
